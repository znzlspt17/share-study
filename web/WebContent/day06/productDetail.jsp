...
<script type="text/javascript">
	window.onload = function() {
		...
		document.getElementById("cart").onclick = function() {
			var cookieValue =
<%=vo.getPno()%>
	document.cookie = "productId=" + cookieValue;
...
<body>
	...
	<div id="container">
		...
		<div id="info">
			<table>
				...
				<tr>
					<td>
						<img src="../images/btn_buy.jpg" alt="">
						<!-- <a href="addCart.jsp?pno=<//%=vo.getPno()%>"> -->
						<img src="../images/btn_cart.jpg" alt="" id="cart" />
						<!-- </a> -->
	...
	<div id="test">
		...
		<p><%=vo.getPname()%></p>
		<p><%=vo.getProdesc()%></p>
		<input type="button" id="closeDiv" value="closeDiv" />
	</div>
